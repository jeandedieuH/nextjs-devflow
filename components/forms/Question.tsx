...
const Question = ({ appUserId }: Props) => {
  const { mode } = useTheme();
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormMessage className="mt-2.5 text-red-600" />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col gap-3">
              ...
              <FormDescription className="body-regular mt-10 text-light-500">
                      ...
                      {field.value.map((tag: any) => (
                        <Badge
                          ...
                          onClick={() => {
                            form.setValue(
                              "tags",
                              field.value.filter((t: any) => t !== tag),
                            );
                          }}
                        >
                          {tag}
                          <Image
                            ...
                            height={12}
                            alt="close"
                            className=" cursor-pointer gap-1 object-contain invert-0 dark:invert"
                          />
                        </Badge>
                      ))}
                    </div>
